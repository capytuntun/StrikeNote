...
- **證照／課程筆記**、**知識區**：跟首頁一樣可以建資料夾、開筆記，只是獨立的一頁，方便把準備考試或整理彙整的筆記跟平常的滲透測試筆記分開放。
...
**所有筆記、證照／課程筆記、知識區之間可以互相搬筆記**：筆記列的「⋯」選單或右鍵選單裡有「換區域…」，選好要搬到哪個區域、要放進那個區域的哪個資料夾（或最上層）就完成了。小說跟隨筆不開放這個功能——小說是為了保護才特別隔開的，隨筆本來就沒有資料夾的概念。
